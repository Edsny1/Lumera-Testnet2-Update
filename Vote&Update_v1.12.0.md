# Lumera v1.12.0 Güncelleme Talimatları
...
### Adım 3: v1.12.0 Binary'sini İndir 📥

```bash
wget -O lumera_v1.12.0_linux_amd64.tar.gz https://github.com/LumeraProtocol/lumera/releases/download/v1.12.0/lumera_v1.12.0_linux_amd64.tar.gz
```
...
rm -f $HOME/lumera_v1.12.0_linux_amd64.tar.gz
```
