# Lumera v1.10.1 Güncelleme Talimatları
...
### Adım 3: v1.10.1 Binary'sini İndir 📥

```bash
wget -O lumera_v1.10.1_linux_amd64.tar.gz https://github.com/LumeraProtocol/lumera/releases/download/v1.10.1/lumera_v1.10.1_linux_amd64.tar.gz
```
...
# Yeni versiyonu kontrol et (v1.10.1 olmalı)
lumerad version
...
rm -f $HOME/lumera_v1.10.1_linux_amd64.tar.gz
```
