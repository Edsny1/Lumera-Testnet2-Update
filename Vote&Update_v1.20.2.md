# Lumera v1.20.2 Güncelleme Talimatları
...
### Adım 3: v1.20.2 Binary'sini İndir 📥

```bash
wget -O lumera_v1.20.2_linux_amd64.tar.gz https://github.com/LumeraProtocol/lumera/releases/download/v1.20.2/lumera_v1.20.2_linux_amd64.tar.gz
```

### Adım 4: Arşivi Çıkar 📦

```bash
tar -xvzf lumera_v1.20.2_linux_amd64.tar.gz
```
...
```bash
ls -l $HOME/.lumera/cosmovisor/upgrades/v1.20.2/bin/
```
...
# Yeni versiyonu kontrol et (v1.20.2 olmalı)
lumerad version
...
rm -f $HOME/lumera_v1.20.2_linux_amd64.tar.gz
```
