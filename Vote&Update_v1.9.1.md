# Lumera v1.9.1 Güncelleme Talimatları
...
lumerad tx gov vote 8 yes --from wallet --chain-id lumera-testnet-2 --gas-prices 0.1ulume --gas auto --gas-adjustment 1.6 -y
```
...
### Adım 3: v1.9.1 Binary'sini İndir 📥
```bash
wget -O lumera_v1.9.1_linux_amd64.tar.gz https://github.com/LumeraProtocol/lumera/releases/download/v1.9.1/lumera_v1.9.1_linux_amd64.tar.gz
```
...
# Yeni versiyonu kontrol et (v1.9.1 olmalı)
lumerad version
...
rm -f $HOME/lumera_v1.9.1_linux_amd64.tar.gz
```
